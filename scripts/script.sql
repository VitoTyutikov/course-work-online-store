...
DROP TABLE IF EXISTS online_shop.deliveries;
...
DROP TABLE IF EXISTS online_shop.stores;
...
VALUES ('MacBook Pro', 1, 1, 1999.99, 'Powerful and portable laptop from Apple',
        'https://example.com/images/macbook-pro.jpg', 4.5, 10, 1),
       ('Galaxy S21', 2, 2, 899.99, 'High-end smartphone from Samsung', 'https://example.com/images/galaxy-s21.jpg',
        4.7, 0, 1),
       ('iPad Air', 1, 3, 599.99, 'Thin and light tablet from Apple', 'https://example.com/images/ipad-air.jpg', 4.6, 5,
        1),
       ('55" OLED TV', 7, 4, 1499.99, 'Stunning OLED TV from LG', 'https://example.com/images/lg-oled-tv.jpg', 4.8, 15,
        1),
       ...
       ('Apple Watch Series 6', 1, 9, 399.99, 'Advanced smartwatch from Apple',
        'https://example.com/images/apple-watch.jpg', 4.8, 0, 1),
...
VALUES ('John', 'Doe', 'johndoe', 'johndoe@mail.com', '123456789', 'password123', 12345, 'New York', '123 Main St',
       ...
       ('Samsung', 'Samsa', 'samsung', 'samsung@mail.com', '', 'passwordsamsung', NULL, NULL, NULL,
        'ROLE_MANUFACTURER'),
       ('Apple', 'aple', 'apple', 'apple@mail.com', '', 'passwordapple', NULL, NULL, NULL, 'ROLE_MANUFACTURER'),
       ('Sony', 'sonya', 'sony', 'sony@mail.com', '', 'passwordsony', NULL, NULL, NULL, 'ROLE_MANUFACTURER'),
       ('TEST_Manager', 'Smith', 'managersmith', 'managersmith@mail.com', '5555555555', 'passwordmanager', NULL, NULL, NULL,
        'ROLE_MANAGER'),
       ('TESTAdmin', 'Jones', 'Noadmin', 'adminjones@mail.com', '5555555555', 'admin', NULL, NULL, NULL,
        'ROLE_ADMIN, ROLE_MANUFACTURER, ROLE_USER'),
       ('TEST_Guest', 'Guest', 'Noguest', 'guest@mail.com', '5555555555', 'passwordguest', NULL, NULL, NULL, 'GUEST');
INSERT INTO online_shop.orders (client_id, store_id, order_date, order_status)
VALUES (1, 1, '2023-03-01', 'Complete'),
       (2, 2, '2023-03-01', 'Pending'),
       (3, 3, '2023-03-01', 'Processing'),
       (4, 4, '2023-03-01', 'Complete'),
       (5, 5, '2023-03-01', 'Complete'),
       (6, 6, '2023-03-01', 'Pending'),
       (7, 7, '2023-03-01', 'Processing'),
       (8, 8, '2023-03-01', 'Complete'),
       (9, 9, '2023-03-01', 'Complete'),
       (10, 10, '2023-03-01', 'Pending');
